...
>>>>>>> dddcd2c31f6400db1ca791c0d16d549d756ccab5
    ...
    def update_predict(
        self, y, cv=None, X=None, update_params=True,
    ):
        ...
        return self._predict_moving_cutoff(
            y=y_inner, cv=cv, X=X_inner, update_params=update_params,
        )

    def update_predict_single(
        self, y=None, fh=None, X=None, update_params=True,
    ):
        ...
        return self._update_predict_single(
            y=y_inner, fh=fh, X=X_inner, update_params=update_params,
        )
    ...
    def _update_predict_single(
        self, y, fh, X=None, update_params=True,
    ):
        ...
        with self._detached_cutoff():
            ...
            for new_window, _ in cv.split(y):
                ...
                y_pred = self._update_predict_single(
                    y_new, fh, X, update_params=update_params,
                )
                if return_pred_int:
